...
CTRL-F through the file to se

aws apigateway import-rest-api --parameters endpointConfigurationTypes=REGIONAL --body file://~/environment/aws-modern-application-workshop/module-4/aws-cli/api-swagger.json --fail-on-warnings

arch for the various places `REPLACE_ME` is located and awaiting your specific parameters.  Once the edits have been made, save the file and execute the following AWS CLI command:
...
aws apigateway create-deployment --rest-api-id yki4m8tzlh --stage-name prod
...
https://yki4m8tzlh.execute-api.us-east-1.amazonaws.com/prod/mysfits
