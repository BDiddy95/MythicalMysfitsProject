...
```
curl -d '{"entry": [1,2,3,4,5]}' https://eu1xcta4ah.execute-api.us-east-1.amazonaws.com/prod/recommendations -X POST
```
...
```
aws s3 cp ~/environment/aws-modern-application-workshop/module-7/web/index.html s3://myth-misfit-aws-proj/
```
